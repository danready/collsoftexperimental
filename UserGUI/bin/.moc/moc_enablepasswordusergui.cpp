...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_EnablePasswordUserGUI_t, stringdata) + ofs \
...
const QMetaObject EnablePasswordUserGUI::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_EnablePasswordUserGUI.data,
      qt_meta_data_EnablePasswordUserGUI,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_EnablePasswordUserGUI.stringdata))
